...
describe('CardPage', () => {
  ...
  it("Should render the card page with id", () => {
    ...
    expect(screen.getByText(`Author: ${firstCard.author}`.trim())).toBeDefined()
    expect(screen.getByText(`Poem name: ${firstCard.name}`.trim())).toBeDefined()
    expect(screen.getByText(`${firstCard.id}. ${firstCard.silaba}`.trim())).toBeDefined()
  ...
  it("Should render the card page with name", () => {
    ...
    expect(screen.getByText(`Poem name: ${lastCard.name}`.trim())).toBeDefined()
    expect(screen.getByText(`${lastCard.id}. ${lastCard.silaba}`.trim())).toBeDefined()
